    ...
    <ListingDesktopFilterContainer>
      <ListingDesktopHead>
        ...
        {!!query.filter.validation &&
          Object.entries(query.filter.validation).some(
            ([key, value]) => ValidationKeys.includes(key as ValidationKey) && !!value,
          ) && <ListingDesktopHead.Clear onClear={clearValidation} />}
      </ListingDesktopHead>
